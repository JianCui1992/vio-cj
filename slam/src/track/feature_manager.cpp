...
void FeatureManager::debugShow()
{
    ...
    for (auto &it : feature)
    {
        ...
        {
            //printf("Error! feature_manager.cpp line 106 \n");
            getchar();
        }        
        if(it.start_frame < 0)
        {
            //printf("Error! feature_manager.cpp line 111 \n");
            getchar();
        }
        if(it.used_num < 0)
        {
            //printf("Error! feature_manager.cpp line 117 \n");
            getchar();
        }
        ...
        if(it.used_num != sum)
        {
            //printf("Error! feature_manager.cpp line 130 \n");
            getchar();
        }
    }
}
...
void FeatureManager::triangulate(Eigen::Vector3d Ps[], Eigen::Vector3d tic[], Eigen::Matrix3d ric[])
{
    for (auto &it_per_id : feature)
    {
        ...
        if(NUM_OF_CAM != 1)
        {
            //printf("Error! feature_manager.cpp line 232 \n");
            getchar();
        }
        ...
        {
            //printf("Error! feature_manager.cpp line 264 \n");
            getchar();
        }
...
{
    // //printf("Error Break! feature_manager.cpp line 285 \n");
    // getchar();
    int i = -1;
    for (auto it = feature.begin(), it_next = feature.begin();
         it != feature.end(); it = it_next)
